...
export default function Dashboard({
  ...
  // ── Business Intelligence: This Week at a Glance ────────────────────────
  const biStats = useMemo(() => {
    ...
    // Active chefs (ordered this week)
    ...
    // At-risk customers (haven't ordered in 14+ days but ordered before)
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm dark:shadow-gray-900/30 border border-gray-100 dark:border-gray-700">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-3 text-center">
              <div className="text-xl font-black text-amber-700 dark:text-amber-300">{shopifyStats.chefs}</div>
              <div className="text-[10px] font-semibold text-amber-600 dark:text-amber-400">🍳 Chef Accounts</div>
            </div>
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-3 text-center">
              <div className="text-xl font-black text-purple-700 dark:text-purple-300">{shopifyStats.subscribers}</div>
            ...
            <div className="bg-sky-50 dark:bg-sky-900/20 rounded-xl p-3 text-center">
              <div className="text-xl font-black text-sky-700 dark:text-sky-300">{shopifyStats.retail}</div>
              <div className="text-[10px] font-semibold text-sky-600 dark:text-sky-400">🛒 Retail</div>
            </div>
            <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-3 text-center">
              <div className="text-xl font-black text-green-700 dark:text-green-300">{shopifyStats.recentTotal}</div>
              <div className="text-[10px] font-semibold text-green-600 dark:text-green-400">📦 Orders (7d)</div>
            </div>
          </div>
          {shopifyStats.recentTotal > 0 && (
            <div className="mt-3 flex gap-3 text-xs text-gray-500 dark:text-gray-400">
              <span>Last 7 days:</span>
              <span className="text-amber-600 dark:text-amber-400 font-semibold">🍳 {shopifyStats.recentChef}</span>
              <span className="text-purple-600 dark:text-purple-400 font-semibold">🔄 {shopifyStats.recentSub}</span>
              <span className="text-sky-600 dark:text-sky-400 font-semibold">🛒 {shopifyStats.recentRetail}</span>
            </div>
          )}
        </div>
      )}
      ...
      {/* ── Learning Engine Intelligence Card ─────────────────────────────── */}
      {leDashboard && (
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm dark:shadow-gray-900/30 border border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between mb-3">
