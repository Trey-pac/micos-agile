        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 pt-16 pb-24 text-center">
          ...
          >
            <motion.button
              ...
              className="px-12 py-5 rounded-2xl bg-green-600 hover:bg-green-700 text-white text-xl font-bold transition-colors cursor-pointer shadow-xl shadow-green-600/25 flex items-center gap-3 mx-auto"
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                ...
                <path d="M5.84 14.09a7.2 7.2 0 0 1 0-4.18V7.07H2.18A11.97 11.97 0 0 0 0 12c0 1.94.46 3.77 1.28 5.4l3.56-2.84z" fill="#fff"/>
                <path d="M12 4.75c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 1.09 14.97 0 12 0 7.7 0 3.99 2.47 2.18 6.07l3.66 2.84c.87-2.6 3.3-4.16 6.16-4.16z" fill="#fff"/>
              </svg>
              Sign In with Google
            </motion.button>
            <motion.button
