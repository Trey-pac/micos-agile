...
import BatchEditPanel from './modals/BatchEditPanel';
...
// ── TaskRow (memoized — only re-renders when its own props change) ────────────
    ...
    <div className="flex flex-col h-full">
      ...
      {selectedTaskIds.size > 0 && (
        <BatchEditPanel
          ...
          batchEditorOpen={batchEditorOpen}
          setBatchEditorOpen={setBatchEditorOpen}
        />
      )}
