...
check('hook: useStatsCollection', fileContains('src/hooks/useLearningEngine.js', 'export function useStatsCollection'));
check('hook: useAlertCount (deprecated wrapper)', fileContains('src/hooks/useLearningEngine.js', 'export function useAlertCount'));
check('hook: useYieldProfiles (deprecated wrapper)', fileContains('src/hooks/useLearningEngine.js', 'export function useYieldProfiles'));
check('AlertContext exists', fileExists('src/contexts/AlertContext.jsx'));
check('OrderBoard uses AlertContext', fileContains('src/components/orders/OrderFulfillmentBoard.jsx', 'useAlerts'));
check('OrderBoard shows anomaly warning', fileContains('src/components/orders/OrderFulfillmentBoard.jsx', 'anomalyAlert'));
check('SowingCalculator uses useStatsCollection', fileContains('src/components/SowingCalculator.jsx', 'useStatsCollection'));
...
check('CustomerManager uses useStatsCollection', fileContains('src/components/CustomerManager.jsx', 'useStatsCollection'));
